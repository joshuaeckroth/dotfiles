...
(defun color-theme-tangotango-josh ()
  ...
  (color-theme-install
   '(color-theme-tangotango-josh
     ...
     (font-lock-function-name-face ((t (:foreground "#edd400" :weight normal))))
     (comint-highlight-input ((t (:italic t :bold t))))
     (comint-highlight-prompt ((t (:foreground "#8ae234"))))
     (isearch ((t (:background "#f57900" :foreground "#2e3436"))))
     (isearch-lazy-highlight-face ((t (:foreground "#2e3436" :background "#e9b96e"))))
     (show-paren-match-face ((t (:foreground "orange" :background "#2e3434"
                                             :bold t :underline t))))
     ...
     (ido-first-match ((t (:foreground "orange" :bold t :weight ultra-bold))))
     (ido-indicator ((t (:background "red" :foreground "yellow" :width condensed))))
     (ido-only-match ((t (:foreground "#6ac214" :weight ultra-bold))))
     (ido-subdir ((t (:foreground "orange" :weight normal :slant italic))))
     (muse-link ((t (:underline t :foreground "dodger blue"))))
     (muse-verbatim ((t (:foreground "orange"))))
     (muse-header-5 ((t (:foreground "orange" :bold t :weight bold :height 1.0))))
     (muse-header-4 ((t (:foreground "orange" :bold t :weight bold :height 1.1))))
     (muse-header-3 ((t (:foreground "orange" :bold t :weight bold :height 1.2))))
     (muse-header-2 ((t (:foreground "orange" :bold t :weight bold :height 1.3))))
     (muse-header-1 ((t (:foreground "orange" :bold t :weight bold :height 1.4))))
)))

(provide 'color-theme-tangotango-josh)
